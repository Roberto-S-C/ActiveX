  ...
  return (
    <div>
      ...
      <div className='flex flex-col justify-center items-center h-screen'>
        ...
        <div className='flex flex-col items-center w-4/5 md:w-3/5 lg:w-2/5 h-3/4 p-4 rounded-lg bg-slate-200'>
          <div className='flex flex-col justify-center items-center w-full h-1/3'>
            <img src={logo} className='w-1/6' />
            <h2 className='text-red-600 text-2xl font-bold'>ActiveX</h2>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col justify-around w-full h-2/3'>
            ...
            <div className='flex justify-center'>
              <button type='submit' className='w-2/3 md:w-1/3 lg:w-1/4 p-2 rounded-lg text-white text-lg bg-red-600 hover:bg-red-700 hover:cursor-pointer'>Submit</button>
            </div>
          </form>
        </div>
