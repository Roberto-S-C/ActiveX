...
function AddressForm({ onSubmit, setAlertDetails, setShowAlert, address }) {
    ...
    return (
        ...
        >
            ...
            <div className='flex flex-col md:flex-row w-11/12 md:w-4/5 lg:w-3/5 md:gap-2'>
            ...
            <div className='flex flex-col md:flex-row justify-between w-11/12 md:w-4/5 lg:w-3/5 md:gap-2'>
                <div className='w-full md:w-2/3 mt-4 md:mt-0'>
                    <input
                        type="text"
                        placeholder="Phone"
            ...
            <input type="submit" className='w-11/12 md:w-4/5 lg:w-1/2 mt-4 md:mt-0 p-3 text-2xl rounded-lg font-bold text-white bg-red-600 hover:bg-red-700 hover:cursor-pointer' />
        </form>
    )
}
