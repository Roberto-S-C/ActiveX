    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-center items-center h-screen'>
                ...
                <div className='flex flex-col items-center w-4/5 md:w-3/5 lg:w-2/5 h-3/5 p-4 rounded-lg bg-slate-200'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col justify-around w-full h-2/3'>
                        ...
                        <div className='flex justify-center'>
                            <button type='submit' className='bg-red-600 w-2/3 md:w-1/3 lg:w-1/4 p-2 rounded-lg text-white text-lg hover:bg-red-700 hover:cursor-pointer'>Submit</button>
                        </div>
                    </form>
                </div>
